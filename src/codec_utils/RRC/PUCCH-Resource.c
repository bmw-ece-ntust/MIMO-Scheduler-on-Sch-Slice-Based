...
static asn_TYPE_member_t asn_MBR_format_7[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct format, choice.format0),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct format, choice.format1),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct format, choice.format2),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct format, choice.format3),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct format, choice.format4),
...
static asn_CHOICE_specifics_t asn_SPC_format_specs_7 = {
	...
	offsetof(struct format, _asn_ctx),
	offsetof(struct format, present),
	sizeof(((struct format *)0)->present),
...
static asn_TYPE_member_t asn_MBR_PUCCH_Resource_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_PUCCH_Resource_specs_1 = {
