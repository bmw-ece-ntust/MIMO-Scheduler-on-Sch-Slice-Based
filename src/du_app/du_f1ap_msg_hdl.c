...
#define print_type(x) printf(#x " is of type %s\n", typeof(x))
...
{
   uint8_t idx = 0;
   ulnrfreq->nRARFCN = duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.fdd.ulNrFreqInfo.nrArfcn;
   ...
   ulnrfreq->freqBandListNr.list.array[0]->freqBandIndicatorNr =
       duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.fdd.ulNrFreqInfo.freqBand[0].nrFreqBand;
...
{
   uint8_t idx = 0;
   dlnrfreq->nRARFCN = duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.fdd.dlNrFreqInfo.nrArfcn;
   ...
   dlnrfreq->freqBandListNr.list.array[0]->freqBandIndicatorNr =
       duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.fdd.dlNrFreqInfo.freqBand[0].nrFreqBand;
...
uint8_t fillNrTddInfo(TDD_Info_t *tddInfo)
{
   ...
   for (freqBandListIdx = 0; freqBandListIdx < freqInfo->freqBandListNr.list.count; freqBandListIdx++)
   {
      ...
      freqInfo->freqBandListNr.list.array[freqBandListIdx]->freqBandIndicatorNr = duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.tdd.nrFreqInfo.freqBand[0].nrFreqBand;
      freqInfo->freqBandListNr.list.array[freqBandListIdx]->supportedSULBandList.list.count = elementCnt;
      freqInfo->freqBandListNr.list.array[freqBandListIdx]->supportedSULBandList.list.size = freqInfo->freqBandListNr.list.array[freqBandListIdx]->supportedSULBandList.list.count * sizeof(SupportedSULFreqBandItem_t *);
...
uint8_t BuildNrMode(NR_Mode_Info_t *mode)
{
   ...
   if (mode->present == NR_Mode_Info_PR_fDD)
   {
      ...
      mode->choice.fDD->uL_Transmission_Bandwidth.nRSCS =
          duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.fdd.ulTxBw.nrScs;
      mode->choice.fDD->uL_Transmission_Bandwidth.nRNRB =
          duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.fdd.ulTxBw.nrb;
      mode->choice.fDD->dL_Transmission_Bandwidth.nRSCS =
          duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.fdd.dlTxBw.nrScs;
      mode->choice.fDD->dL_Transmission_Bandwidth.nRNRB =
          duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.fdd.dlTxBw.nrb;
   }
...
uint8_t BuildExtensions(ProtocolExtensionContainer_4624P3_t **ieExtend)
{
   ...
   (*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.count = elementCnt;
   (*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.size = (*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.count * sizeof(SliceSupportItem_t *);

   DU_ALLOC((*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array, elementCnt * sizeof(SliceSupportItem_t *));
   if ((*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array == NULLP)
   {
      DU_LOG("ERROR  --> DU_APP : BuildExtensions(): Memory allocation failed");
      return RFAILED;
   }
   ...
   {
      DU_ALLOC((*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx], sizeof(SliceSupportItem_t));
      if ((*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx] == NULLP)
      {
         DU_LOG("ERROR  --> DU_APP : BuildExtensions(): Memory allocation failed");
         return RFAILED;
      }
      (*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sST.size = sizeof(uint8_t);
      DU_ALLOC((*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sST.buf, (*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sST.size);
      if ((*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sST.buf == NULLP)
      {
         DU_LOG("ERROR  --> DU_APP : BuildExtensions(): Memory allocation failed");
         return RFAILED;
      }
      (*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sST.buf[0] = duCfgParam.srvdCellLst[0].duCellInfo.cellInfo.srvdPlmn[0].taiSliceSuppLst.snssai[sliceLstIdx]->sst;

      DU_ALLOC((*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD, sizeof(OCTET_STRING_t));
      if ((*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD == NULLP)
      {
         DU_LOG("ERROR  --> DU_APP : BuildExtensions(): Memory allocation failed");
         return RFAILED;
      }
      (*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD->size = 3 * sizeof(uint8_t);
      DU_ALLOC((*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD->buf, (*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD->size);
      if ((*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD->buf == NULLP)
      {
         DU_LOG("ERROR  --> DU_APP : BuildExtensions(): Memory allocation failed");
         return RFAILED;
      }
      memcpy((*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD->buf, duCfgParam.srvdCellLst[0].duCellInfo.cellInfo.srvdPlmn[0].taiSliceSuppLst.snssai[sliceLstIdx]->sd, (*ieExtend)->list.array[idx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD->size);
   }
   return ROK;
}
/*******************************************************************
...
uint8_t BuildServedCellList(GNB_DU_Served_Cells_List_t *duServedCell)
{
   ...
   DU_ALLOC(srvCellItem->served_Cell_Information.measurementTimingConfiguration.buf, srvCellItem->served_Cell_Information.measurementTimingConfiguration.size);
...
uint8_t BuildRrcVer(RRC_Version_t *rrcVer)
{
   ...
   rrcVer->iE_Extensions->list.array[rrcExt]->extensionValue.choice.Latest_RRC_Version_Enhanced.size = 3 * sizeof(uint8_t);
   DU_ALLOC(rrcVer->iE_Extensions->list.array[rrcExt]->extensionValue.choice.Latest_RRC_Version_Enhanced.buf, rrcVer->iE_Extensions->list.array[rrcExt]->extensionValue.choice.Latest_RRC_Version_Enhanced.size);
   if (rrcVer->iE_Extensions->list.array[rrcExt]->extensionValue.choice.Latest_RRC_Version_Enhanced.buf == NULLP)
   {
      return RFAILED;
   }
   rrcLatest = 0;
   rrcVer->iE_Extensions->list.array[rrcExt]->extensionValue.choice.Latest_RRC_Version_Enhanced.buf[rrcLatest] = 15;
   rrcLatest++;
   rrcVer->iE_Extensions->list.array[rrcExt]->extensionValue.choice.Latest_RRC_Version_Enhanced.buf[rrcLatest] = 5;
   rrcLatest++;
   rrcVer->iE_Extensions->list.array[rrcExt]->extensionValue.choice.Latest_RRC_Version_Enhanced.buf[rrcLatest] = 0;
   return ROK;
}
/*******************************************************************
 *
   ...
   if (rrcVer->latest_RRC_Version.buf != NULLP)
   {
      if (rrcVer->iE_Extensions != NULLP)
      {
         if (rrcVer->iE_Extensions->list.array != NULLP)
         {
            if (rrcVer->iE_Extensions->list.array[0] != NULLP)
            {
               if (rrcVer->iE_Extensions->list.array[0]->extensionValue.choice.Latest_RRC_Version_Enhanced.buf != NULLP)
               {
                  DU_FREE(rrcVer->iE_Extensions->list.array[0]->extensionValue.choice.Latest_RRC_Version_Enhanced.buf, rrcVer->iE_Extensions->list.array[0]->extensionValue.choice.Latest_RRC_Version_Enhanced.size);
               }
...
void freeFddNrFreqInfo(FDD_Info_t *fDD)
{
   ...
   if (fDD != NULLP)
   {
      ...
      {
         DU_FREE(fDD->uL_NRFreqInfo.freqBandListNr.list.array[arrIdx], sizeof(FreqBandNrItem_t));
      ...
      {
         DU_FREE(fDD->dL_NRFreqInfo.freqBandListNr.list.array[arrIdx], sizeof(FreqBandNrItem_t));
            ...
            if (srvCellItem->served_Cell_Information.servedPLMNs.list.array[plmnIdx] != NULLP)
            {
               ...
               if (servedPlmnItem->iE_Extensions != NULLP)
               {
                  if (servedPlmnItem->iE_Extensions->list.array != NULLP)
                  {
                     ...
                     {
                        if (servedPlmnItem->iE_Extensions->list.array[0]->extensionValue.choice.SliceSupportList.list.array != NULLP)
                        {
                           for (sliceIdx = 0; sliceIdx < servedPlmnItem->iE_Extensions->list.array[0]->extensionValue.choice.SliceSupportList.list.count; sliceIdx++)
                           {
                              if (servedPlmnItem->iE_Extensions->list.array[0]->extensionValue.choice.SliceSupportList.list.array[sliceIdx] != NULLP)
                              {
                                 sliceSupportItem = servedPlmnItem->iE_Extensions->list.array[0]->extensionValue.choice.SliceSupportList.list.array[sliceIdx];
                           ...
                           DU_FREE(servedPlmnItem->iE_Extensions->list.array[0]->extensionValue.choice.SliceSupportList.list.array, servedPlmnItem->iE_Extensions->list.array[0]->extensionValue.choice.SliceSupportList.list.size);
                        }
            ...
            for (ieIdx = 0; ieIdx < f1SetupReq->protocolIEs.list.count; ieIdx++)
            {
               if (f1SetupReq->protocolIEs.list.array[ieIdx] != NULLP)
               {
                  ...
                  case ProtocolIE_ID_id_gNB_DU_Served_Cells_List:
                     FreeServedCellList(&f1SetupReq->protocolIEs.list.array[ieIdx]->value.choice.GNB_DU_Served_Cells_List);
                     break;
         ...
         if (servedPlmnItem->iE_Extensions != NULLP)
         {
            if (servedPlmnItem->iE_Extensions->list.array != NULLP)
            {
               if (servedPlmnItem->iE_Extensions->list.array[arrIdx] != NULLP)
               {
                  ...
                  {
                     for (sliceLstIdx = 0; sliceLstIdx < servedPlmnItem->iE_Extensions->list.array[arrIdx]->extensionValue.choice.SliceSupportList.list.count; sliceLstIdx++)
                     {
                        if (servedPlmnItem->iE_Extensions->list.array[arrIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx] != NULLP)
                        {
                           ...
                           DU_FREE(servedPlmnItem->iE_Extensions->list.array[arrIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx], sizeof(SliceSupportItem_t));
                        }
                     }
         ...
         if (duCfgUpdate->protocolIEs.list.array != NULLP)
         {
            for (ieIdx = 0; ieIdx < duCfgUpdate->protocolIEs.list.count; ieIdx++)
            {
               if (duCfgUpdate->protocolIEs.list.array[ieIdx] != NULLP)
               {
                  ...
                  {
                     cellsToModify = &duCfgUpdate->protocolIEs.list.array[ieIdx]->value.choice.Served_Cells_To_Modify_List;
                     if (cellsToModify->list.array != NULLP)
                     {
                        for (cellModifyIdx = 0; cellModifyIdx < cellsToModify->list.count; cellModifyIdx++)
                        {
                           ...
                           {
                              freeCellsToModifyItem(&cellsToModify->list.array[cellModifyIdx]->value.choice.Served_Cells_To_Modify_Item);
                  ...
                  {
                     cellsToDelete = &duCfgUpdate->protocolIEs.list.array[ieIdx]->value.choice.Served_Cells_To_Delete_List;
...
uint8_t fillServedPlmns(ServedPLMNs_List_t *servedPlmn)
{
   ...
   DU_ALLOC(servedPlmn->list.array[arrayIdx]->pLMN_Identity.buf, servedPlmn->list.array[arrayIdx]->pLMN_Identity.size);
   ...
   DU_ALLOC(servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array, servedPlmn->list.array[arrayIdx]->iE_Extensions->list.size);
   ...
   servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.present =
       ServedPLMNs_ItemExtIEs__extensionValue_PR_SliceSupportList;
   servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.count = elementCnt;
   servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.size = elementCnt * sizeof(SliceSupportItem_t *);
   DU_ALLOC(servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array, servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.size);
   if (servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array == NULLP)
   {
      DU_LOG("ERROR  --> DU_APP : fillServedPlmns(): Memory allocation failed");
      return RFAILED;
   }
   ...
   for (sliceLstIdx = 0; sliceLstIdx < elementCnt; sliceLstIdx++)
   {
      DU_ALLOC(servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx], sizeof(SliceSupportItem_t));
      if (servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx] == NULLP)
      {
         DU_LOG("ERROR  --> DU_APP : fillServedPlmns(): Memory allocation failed");
         return RFAILED;
      }

      servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sST.size = sizeof(uint8_t);
      DU_ALLOC(servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sST.buf, servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sST.size);

      if (servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sST.buf == NULLP)
      {
         DU_LOG("ERROR  --> DU_APP : fillServedPlmns(): Memory allocation failed");
         return RFAILED;
      }
      servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sST.buf[arrayIdx] = duCfgParam.srvdCellLst[arrayIdx].duCellInfo.cellInfo.srvdPlmn[arrayIdx].taiSliceSuppLst.snssai[sliceLstIdx]->sst;

      DU_ALLOC(servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD, sizeof(OCTET_STRING_t));
      if (servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD == NULLP)
      {
         DU_LOG("ERROR  --> DU_APP : fillServedPlmns(): Memory allocation failed");
         return RFAILED;
      }
      servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD->size = 3 * sizeof(uint8_t);
      DU_ALLOC(servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD->buf, servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD->size);
      if (servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD->buf == NULLP)
      {
         DU_LOG("ERROR  --> DU_APP : fillServedPlmns(): Memory allocation failed");
         return RFAILED;
      }
      memcpy(servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD->buf, duCfgParam.srvdCellLst[arrayIdx].duCellInfo.cellInfo.srvdPlmn[arrayIdx].taiSliceSuppLst.snssai[sliceLstIdx]->sd,
             servedPlmn->list.array[arrayIdx]->iE_Extensions->list.array[ieIdx]->extensionValue.choice.SliceSupportList.list.array[sliceLstIdx]->sNSSAI.sD->size);
   }
   return ROK;
}
...
{
   fDD->uL_NRFreqInfo.nRARFCN = duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.fdd.ulNrFreqInfo.nrArfcn;
   fDD->uL_NRFreqInfo.freqBandListNr.list.count = 1;
   fDD->uL_NRFreqInfo.freqBandListNr.list.size = sizeof(FreqBandNrItem_t *);
   DU_ALLOC(fDD->uL_NRFreqInfo.freqBandListNr.list.array, fDD->uL_NRFreqInfo.freqBandListNr.list.size);
   if (fDD->uL_NRFreqInfo.freqBandListNr.list.array == NULLP)
   {
   ...
   fDD->dL_NRFreqInfo.nRARFCN = duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.fdd.dlNrFreqInfo.nrArfcn;
   ...
   fDD->uL_Transmission_Bandwidth.nRSCS = duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.fdd.ulTxBw.nrScs;
   fDD->uL_Transmission_Bandwidth.nRNRB = duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.fdd.ulTxBw.nrb;
   fDD->dL_Transmission_Bandwidth.nRSCS = duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.fdd.dlTxBw.nrScs;
   fDD->dL_Transmission_Bandwidth.nRNRB = duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.fdd.dlTxBw.nrb;
...
uint8_t fillServedCellInfo(Served_Cell_Information_t *srvCellInfo)
{
   ...
   DU_ALLOC(srvCellInfo->measurementTimingConfiguration.buf, srvCellInfo->measurementTimingConfiguration.size);
   if (srvCellInfo->measurementTimingConfiguration.buf == NULLP)
   {
      return RFAILED;
   }
   srvCellInfo->measurementTimingConfiguration.buf[0] = duCfgParam.srvdCellLst[0].duCellInfo.measTimeCfg;
...
uint8_t BuildAndSendDUConfigUpdate(ServCellAction servCellAction)
{
   ...
   while (true)
   {
      ...
      if (servCellAction == SERV_CELL_TO_MODIFY)
      {
         ...
         if (buildServCellToModList(&duCfgUpdate->protocolIEs.list.array[ieIdx]->value.choice.Served_Cells_To_Modify_List))
         {
      ...
      else
      {
         ...
         if (buildServCellToDeleteList(&duCfgUpdate->protocolIEs.list.array[ieIdx]->value.choice.Served_Cells_To_Delete_List) != ROK)
         {
...
uint8_t BuildSrsRsrcAddModList(struct SRS_Config__srs_ResourceToAddModList *resourceList)
{
   ...
   resourceList->list.array[rsrcIdx]->transmissionComb.choice.n2->combOffset_n2 = SRS_COMB_OFFSET_N2;
   resourceList->list.array[rsrcIdx]->transmissionComb.choice.n2->cyclicShift_n2 = SRS_CYCLIC_SHIFT_N2;
    ...
    struct SRS_Config__srs_ResourceSetToAddModList *rsrcSetList)
{
   ...
   *rsrcIdList->list.array[rsrcIdx] = SRS_RSRC_ID;
   ...
   rsrcSetList->list.array[rSetIdx]->resourceType.choice.aperiodic->aperiodicSRS_ResourceTrigger = APERIODIC_SRS_RESRC_TRIGGER;
...
uint8_t BuildNzpCsiRsToAddModList(struct CSI_MeasConfig__nzp_CSI_RS_ResourceToAddModList *nzpCsiRsToAddModList)
{
   ...
   {
      item = NULLP;
      DU_ALLOC(item, sizeof(struct NZP_CSI_RS_Resource));
      if (item == NULLP)
      {
      ...
      DU_ALLOC(item->resourceMapping.frequencyDomainAllocation.choice.row2.buf, item->resourceMapping.frequencyDomainAllocation.choice.row2.size);
      ...
      *(item->resourceMapping.firstOFDMSymbolInTimeDomain2) = 2;
      ...
      DU_ALLOC(item->powerControlOffsetSS, sizeof(*item->powerControlOffsetSS));
...
uint8_t BuildCsiResourceConfigToAddModList(struct CSI_MeasConfig__csi_ResourceConfigToAddModList *csiResourceConfigToAddModList)
{
   ...
   {
      item1 = NULLP;
      DU_ALLOC(item1, sizeof(struct CSI_ResourceConfig));
      if (item1 == NULLP)
      {
      ...
      DU_ALLOC(item1->csi_RS_ResourceSetList.choice.nzp_CSI_RS_SSB->nzp_CSI_RS_ResourceSetList, sizeof(*item1->csi_RS_ResourceSetList.choice.nzp_CSI_RS_SSB->nzp_CSI_RS_ResourceSetList))
...
uint8_t BuildCsiMeasCfg(struct ServingCellConfig__csi_MeasConfig *csiMeasCfg)
{
   ...
   DU_ALLOC(csiMeasCfg->choice.setup->csi_ResourceConfigToAddModList, sizeof(struct CSI_MeasConfig__csi_ResourceConfigToAddModList));
   ...
   DU_ALLOC(csiMeasCfg->choice.setup->nzp_CSI_RS_ResourceSetToAddModList, sizeof(struct CSI_MeasConfig__nzp_CSI_RS_ResourceSetToAddModList));
   ...
   DU_ALLOC(csiMeasCfg->choice.setup->nzp_CSI_RS_ResourceToAddModList, sizeof(struct CSI_MeasConfig__nzp_CSI_RS_ResourceToAddModList));
...
uint8_t BuildSpCellCfgDed(DuUeCb *ueCb, ServingCellConfig_t *srvCellCfg)
{
   ...
   if (ueCb == NULLP)
   {
      *(srvCellCfg->firstActiveDownlinkBWP_Id) = ACTIVE_DL_BWP_ID;
      DU_LOG("ueCb Null in firstactiveDLBWP");
   }
   else
   ...
   if (ueCb == NULLP)
   {
      *(srvCellCfg->defaultDownlinkBWP_Id) = ACTIVE_DL_BWP_ID;
      DU_LOG("ueCb Null in defaultDLBWP");
   }
   else
...
uint8_t BuildDrxConfigRrc(DuUeCb *ueCb, struct MAC_CellGroupConfig__drx_ConfigRrc *drxCfg)
{
   ...
   if (ueCb->duMacUeCfg.macCellGrpCfg.drxCfg.drxOnDurationTimer.onDurationTimerValInMs)
   {
      ...
      drxCfg->choice.setup->drx_onDurationTimer.choice.milliSeconds = convertOnDurationTimerMilliSecondsValueToEnum(ueCb->duMacUeCfg.macCellGrpCfg.drxCfg.drxOnDurationTimer.onDurationtimerValue.milliSeconds);
   }
   else
   {
      drxCfg->choice.setup->drx_onDurationTimer.present = DRX_ConfigRrc__drx_onDurationTimer_PR_subMilliSeconds;
      drxCfg->choice.setup->drx_onDurationTimer.choice.subMilliSeconds = ueCb->duMacUeCfg.macCellGrpCfg.drxCfg.drxOnDurationTimer.onDurationtimerValue.subMilliSeconds;
   }
   ...
   drxCfg->choice.setup->drx_RetransmissionTimerDL = convertDrxRetransmissionTimerDlValueToEnum(ueCb->duMacUeCfg.macCellGrpCfg.drxCfg.drxRetransmissionTimerDl);
   drxCfg->choice.setup->drx_RetransmissionTimerUL = convertDrxRetransmissionTimerUlValueToEnum(ueCb->duMacUeCfg.macCellGrpCfg.drxCfg.drxRetransmissionTimerUl);
   ...
   if (ueCb->duMacUeCfg.macCellGrpCfg.drxCfg.shortDrxPres)
   {
      ...
      {
         drxCfg->choice.setup->shortDRX->drx_ShortCycle = convertShortDrxCycleLengthValueToEnum(ueCb->duMacUeCfg.macCellGrpCfg.drxCfg.shortDrx.drxShortCycle);
      ...
      if (ulCfg->firstActiveUplinkBWP_Id)
      {
         if (ulCfg->pusch_ServingCellConfig)
         {
            ...
            if (puschCfg->choice.setup)
            {
               if (puschCfg->choice.setup->ext1)
               {
                  DU_FREE(puschCfg->choice.setup->ext1->processingType2Enabled, sizeof(BOOLEAN_t));
                  DU_FREE(puschCfg->choice.setup->ext1->maxMIMO_Layers, sizeof(long));
...
uint8_t BuildCellGroupConfigRrc(DuUeCb *ueCb, OCTET_STRING_t *duToCuRrcContainer)
{
   ...
   while (true)
   {
      ...
      if (encRetVal.encoded == ENCODE_FAIL)
      {
         ...
         DU_LOG("\nERROR  --> F1AP : Could not encode DuToCuRrcContainer (at %d)\n",
         ...
         errReturn = asn_check_constraints(&asn_DEF_CellGroupConfigRrc, &cellGrpCfg, errbuf, &errlen);

         DU_LOG("\nTEST");
         DU_LOG("\nCHECK CONSTRAINT in DutoCuRrcContainer ---> errReturn = %d", errReturn);
         DU_LOG("\nCHECK CONSTRAINT in DutoCuRrcContainer ---> Error Check ASN : %s, err length : %d\n", errbuf, (int)errlen);
                                          ...
                                          uint16_t rrcContSize, uint8_t *rrcContainer)
{
   ...
   while (true)
   {
      ...
      if (encRetVal.encoded == ENCODE_FAIL)
      {
         ...
         // errReturn = asn_check_constraints(&asn_DEF_CellGroupConfigRrc,&f1apMsg,errbuf,&errlen);
         // DU_LOG("\nTEST");
         // DU_LOG("\nCHECK CONSTRAINT ---> errReturn = %d",errReturn);
         // DU_LOG("\nCHECK CONSTRAINT ---> Error Check ASN : %s, err length : %d\n",errbuf,(int)errlen);
         ret = RFAILED;
         break;
      }
      else
         ...
         case MAC_CellGroupConfig__drx_ConfigRrc_PR_setup:
         {
            ...
            if (cuDrxConfig)
            {
               ...
               case DRX_ConfigRrc__drx_onDurationTimer_PR_milliSeconds:
               {
                  ...
                  drxCfg->drxOnDurationTimer.onDurationtimerValue.milliSeconds = convertOnDurationTimerMilliSecondsEnumToValue(cuDrxConfig->drx_onDurationTimer.choice.milliSeconds);
                  break;
               }
   ...
   if (ulInfo->list.array != NULLP)
   {
      for (ulIdx = 0; ulIdx < ulInfo->list.count; ulIdx++)
      {
         if (ulIdx == 0 && ulInfo->list.array[ulIdx] != NULLP)
         {
            ...
            {
               if (ulInfo->list.array[ulIdx]->uLUPTNLInformation.choice.gTPTunnel->transportLayerAddress.buf != NULLP)
               {
                  if (ulInfo->list.array[ulIdx]->uLUPTNLInformation.choice.gTPTunnel->gTP_TEID.buf != NULLP)
                  {
                     free(ulInfo->list.array[ulIdx]->uLUPTNLInformation.choice.gTPTunnel->gTP_TEID.buf);
                  }
                  free(ulInfo->list.array[ulIdx]->uLUPTNLInformation.choice.gTPTunnel->transportLayerAddress.buf);
               }
   ...
   if (drbSet->list.array != NULLP)
   {
      for (drbIdx = 0; drbIdx < drbSet->list.count; drbIdx++)
      {
         if (drbIdx == 0 && drbSet->list.array[drbIdx] != NULLP)
         {
            ...
            {
               if (drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.dRB_QoS.qoS_Characteristics.choice.non_Dynamic_5QI != NULLP)
               {
                  if (drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.dRB_QoS.qoS_Characteristics.choice.non_Dynamic_5QI->averagingWindow != NULLP)
                  {
                     if (drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.dRB_QoS.qoS_Characteristics.choice.non_Dynamic_5QI->maxDataBurstVolume != NULLP)
                     {
                        ...
                        if (drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.sNSSAI.sST.buf != NULLP)
                        {
                           ...
                           if (drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.sNSSAI.sD != NULLP)
                           {
                              ...
                              if (drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.sNSSAI.sD->buf != NULLP)
                              {
                                 ...
                                 if (drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.flows_Mapped_To_DRB_List.list.array != NULLP)
                                 {

                                    for (flowIdx = 0; flowIdx < drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.flows_Mapped_To_DRB_List.list.count; flowIdx++)
                                    {

                                       if (flowIdx == 0 && drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.flows_Mapped_To_DRB_List.list.array[flowIdx] != NULLP)
                                       {
                                          if (drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.flows_Mapped_To_DRB_List.list.array[flowIdx]->qoSFlowLevelQoSParameters.qoS_Characteristics.choice.non_Dynamic_5QI != NULLP)
                                          {
                                             if (drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.flows_Mapped_To_DRB_List.list.array[flowIdx]->qoSFlowLevelQoSParameters.qoS_Characteristics.choice.non_Dynamic_5QI->averagingWindow != NULLP)
                                             {

                                                if (drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.flows_Mapped_To_DRB_List.list.array[flowIdx]->qoSFlowLevelQoSParameters.qoS_Characteristics.choice.non_Dynamic_5QI->maxDataBurstVolume != NULLP)
                                                {

                                                   free(drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.flows_Mapped_To_DRB_List.list.array[flowIdx]->qoSFlowLevelQoSParameters.qoS_Characteristics.choice.non_Dynamic_5QI->maxDataBurstVolume);
                                                }

                                                free(drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.flows_Mapped_To_DRB_List.list.array[flowIdx]->qoSFlowLevelQoSParameters.qoS_Characteristics.choice.non_Dynamic_5QI->averagingWindow);
                                             }
                                       ...
                                       if (drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.flows_Mapped_To_DRB_List.list.array[flowIdx] != NULLP)
                                       {

                                          free(drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.flows_Mapped_To_DRB_List.list.array[flowIdx]);
                                       }
                                    }

                                    free(drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.flows_Mapped_To_DRB_List.list.array);
                                 }

                                 free(drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.sNSSAI.sD->buf);
                              }
                     ...
                     free(drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.dRB_QoS.qoS_Characteristics.choice.non_Dynamic_5QI->averagingWindow);
                  }

                  free(drbSetItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.dRB_QoS.qoS_Characteristics.choice.non_Dynamic_5QI);
               }
                              ...
                              DRBs_ToBeSetupMod_Item_t *drbSetupModItem, DRBs_ToBeModified_Item_t *drbModItem, DuLcCfg *macLcToAdd, DuRlcBearerCfg *rlcLcToAdd, UpTnlCfg *upTnlInfo, DuRlcUeCfg *storedRlcUeCfg)
{
   ...
   {
      /* Filling RLC INFO */
      procRlcLcCfg(drbItem->dRBID, lcId, RB_TYPE_DRB, drbItem->rLCMode, CONFIG_ADD, NULL, rlcLcToAdd, &drbItem->qoSInformation);
...
void FreeUeContextSetupRsp(F1AP_PDU_t *f1apMsg)
{
   ...
   if (f1apMsg)
   {
      ...
      {
         ueSetRsp = &f1apMsg->choice.successfulOutcome->value.choice.UEContextSetupResponse;
            ...
            for (idx = 0; idx < ueSetRsp->protocolIEs.list.count; idx++)
            {
               if (ueSetRsp->protocolIEs.list.array[idx])
               {
                  ...
                  case ProtocolIE_ID_id_DUtoCURRCInformation:
                  {
                     ...
                     cellGrpCfg = &ueSetRsp->protocolIEs.list.array[idx]->value.choice.DUtoCURRCInformation.cellGroupConfig;
               ...
               if (cellToActivate->list.array)
               {
                  for (arrIdx = 0; arrIdx < cellToActivate->list.count; arrIdx++)
                  {
                     if (cellToActivate->list.array[arrIdx])
                     {
                        ...
                        {
                           if (cellToActivate->list.array[0]->value.choice.Cells_to_be_Activated_List_Item.nRCGI.nRCellIdentity.buf)
                           {
                              free(cellToActivate->list.array[0]->value.choice.Cells_to_be_Activated_List_Item.nRCGI.nRCellIdentity.buf);
                           }

                           free(cellToActivate->list.array[0]->value.choice.Cells_to_be_Activated_List_Item.nRCGI.pLMN_Identity.buf);
                        }
                  ...
                  if (rrcVer->iE_Extensions)
                  {
                     if (rrcVer->iE_Extensions->list.array)
                     {
                        if (rrcVer->iE_Extensions->list.array[0])
                        {
                           ...
                           {
                              free(rrcVer->iE_Extensions->list.array[0]->extensionValue.choice.Latest_RRC_Version_Enhanced.buf);
                           }
...
uint8_t procF1SetupRsp(F1AP_PDU_t *f1apMsg, MsgLen recvBufLen, char *recvBuf)
{
   ...
   for (idx = 0; idx < f1SetRspMsg->protocolIEs.list.count; idx++)
   {
      ...
      case ProtocolIE_ID_id_Cells_to_be_Activated_List:
      {
         extractCellsToBeActivated(f1SetRspMsg->protocolIEs.list.array[idx]->value.choice.Cells_to_be_Activated_List);
         break;
      }
      case ProtocolIE_ID_id_TransactionID:
      {
         f1SetRspDb.transId = f1SetRspMsg->protocolIEs.list.array[idx]->value.choice.TransactionID;
         break;
      }
      case ProtocolIE_ID_id_gNB_CU_Name:
      {
         cuName = &f1SetRspMsg->protocolIEs.list.array[idx]->value.choice.GNB_CU_Name;
   ...
   if (f1apMsgPdu)
   {
      if (f1apMsgPdu->choice.initiatingMessage)
      {
         ...
         for (ieIdx = 0; ieIdx < gnbDuConfigUpdate->protocolIEs.list.count; ieIdx++)
         {
            ...
            case ProtocolIE_ID_id_Served_Cells_To_Delete_List:
            {
               cellsToDelete = &gnbDuConfigUpdate->protocolIEs.list.array[ieIdx]->value.choice.Served_Cells_To_Delete_List;
         ...
         if (ueContextModifyRes->protocolIEs.list.array)
         {
            for (ieIdx = 0; ieIdx < ueContextModifyRes->protocolIEs.list.count; ieIdx++)
            {
               if (ueContextModifyRes->protocolIEs.list.array[ieIdx])
               {
                  ...
                  {
                     FreeDrbSetupModList(&(ueContextModifyRes->protocolIEs.list.array[ieIdx]->value.choice.DRBs_SetupMod_List));
                     break;
                  }
                  case ProtocolIE_ID_id_DRBs_Modified_List:
                  {
                     FreeDrbModList(&(ueContextModifyRes->protocolIEs.list.array[ieIdx]->value.choice.DRBs_Modified_List));
                     break;
                  }
                  case ProtocolIE_ID_id_SRBs_SetupMod_List:
                  {
                     FreeSrbSetupModList(&(ueContextModifyRes->protocolIEs.list.array[ieIdx]->value.choice.SRBs_SetupMod_List));
                     break;
                  }
                  }
...
uint8_t BuildAndSendUeContextModRsp(DuUeCb *ueCb)
{
   ...
   while (true)
   {
          ...
          ((ueCb->f1UeDb->actionType == UE_CTXT_MOD) && (ueCb->f1UeDb->duUeCfg.numDrbSetupMod)))
      {
         ...
         ret = BuildDrbSetupModList(&(ueContextModifyRes->protocolIEs.list.array[ieIdx]->value.choice.DRBs_SetupMod_List), &ueCb->f1UeDb->duUeCfg);
         if (ret != ROK)
         {
      ...
      if ((ueCb->f1UeDb->actionType == UE_CTXT_MOD) && (ueCb->f1UeDb->duUeCfg.numDrbModified))
      {
         ...
         ret = BuildDrbModList(&(ueContextModifyRes->protocolIEs.list.array[ieIdx]->value.choice.DRBs_Modified_List), &ueCb->f1UeDb->duUeCfg);
         if (ret != ROK)
         {
         ...
         if (ulInfo->list.array[arrIdx])
         {
            if (ulInfo->list.array[arrIdx]->uLUPTNLInformation.choice.gTPTunnel)
            {
               if (ulInfo->list.array[arrIdx]->uLUPTNLInformation.choice.gTPTunnel->transportLayerAddress.buf)
               {
                  ...
                  {
                     free(ulInfo->list.array[arrIdx]->uLUPTNLInformation.choice.gTPTunnel->gTP_TEID.buf);
                  }
                  free(ulInfo->list.array[arrIdx]->uLUPTNLInformation.choice.gTPTunnel->transportLayerAddress.buf);
               }
...
void freeAperDecodeDrbSetupModItem(DRBs_ToBeSetupMod_Item_t *drbItem)
{
   ...
   case QoSInformation_PR_choice_extension:
   {
      ...
      {
         freeAperDecodeQosInfo(&drbItem->qoSInformation.choice.choice_extension->value.choice.DRB_Information.dRB_QoS);
   ...
   if (ueContextModifyReq->protocolIEs.list.array)
   {
      for (arrIdx = 0; arrIdx < ueContextModifyReq->protocolIEs.list.count; arrIdx++)
      {
         if (ueContextModifyReq->protocolIEs.list.array[arrIdx])
         {
            ...
            {
               freeAperDecodeDrbToBeSetupModList(&ueContextModifyReq->protocolIEs.list.array[arrIdx]->value.choice.DRBs_ToBeSetupMod_List);
               break;
            }
            case ProtocolIE_ID_id_DRBs_ToBeModified_List:
            {
               freeAperDecodeDrbToBeModifiedList(&ueContextModifyReq->protocolIEs.list.array[arrIdx]->value.choice.DRBs_ToBeModified_List);
               break;
            }
            case ProtocolIE_ID_id_DRBs_ToBeReleased_List:
            {
               freeAperDecodeDrbToBeReleasedList(&ueContextModifyReq->protocolIEs.list.array[arrIdx]->value.choice.DRBs_ToBeReleased_List);
               break;
            }
   ...
   for (ieIdx = 0; (ieIdx < ueContextModifyReq->protocolIEs.list.count && ret == ROK); ieIdx++)
   {
      ...
      case ProtocolIE_ID_id_RRCContainer:
      {
         ...
         else
         {
            ...
            memset(duUeCb->f1UeDb->dlRrcMsg, 0, sizeof(F1DlRrcMsg));
            ret = extractDlRrcMsg(gnbDuUeF1apId, gnbCuUeF1apId, duUeCb->f1UeDb->dlRrcMsg,
                                  &ueContextModifyReq->protocolIEs.list.array[ieIdx]->value.choice.RRCContainer);
         }
      ...
      case ProtocolIE_ID_id_DRBs_ToBeReleased_List:
      {
         if (duUeCb->f1UeDb)
         {
            ...
            {
               drbSetupModCfg = &ueContextModifyReq->protocolIEs.list.array[ieIdx]->value.choice.DRBs_ToBeSetupMod_List;
            ...
            {
               drbModifiedCfg = &ueContextModifyReq->protocolIEs.list.array[ieIdx]->value.choice.DRBs_ToBeModified_List;
            ...
            {
               drbToRelease = &ueContextModifyReq->protocolIEs.list.array[ieIdx]->value.choice.DRBs_ToBeReleased_List;
...
uint8_t BuildAndSendUeContextReleaseComplete(uint16_t cellId, uint32_t gnbCuUeF1apId, uint32_t gnbDuUeF1apId)
{
   ...
   if ((ret == ROK) && (duCb.actvCellLst[cellId - 1]) && (duCb.actvCellLst[cellId - 1]->cellStatus == DELETION_IN_PROGRESS) && (duCb.actvCellLst[cellId - 1]->numActvUes == 0))
   {
      ret = duSendCellDeletReq(cellId);
      if (ret != ROK)
      {
   ...
   if (ueContextReleaseCommand->protocolIEs.list.array)
   {
      for (ieIdx = 0; ieIdx < ueContextReleaseCommand->protocolIEs.list.count; ieIdx++)
      {
         if (ueContextReleaseCommand->protocolIEs.list.array[ieIdx])
         {
            ...
            default:
               DU_LOG("\nERROR  -->  F1AP: freeAperDecodeUeContextReleaseCommand():Invalid IE Received: %ld", ueContextReleaseCommand->protocolIEs.list.array[ieIdx]->id);
               break;
            }
         }
   ...
   if (ueContextReleaseCommand->protocolIEs.list.array)
   {
      for (ieIdx = 0; ieIdx < ueContextReleaseCommand->protocolIEs.list.count; ieIdx++)
      {
         if (ueContextReleaseCommand->protocolIEs.list.array[ieIdx])
         {
            ...
            case ProtocolIE_ID_id_gNB_CU_UE_F1AP_ID:
            {
               gnbCuUeF1apId = ueContextReleaseCommand->protocolIEs.list.array[ieIdx]->value.choice.GNB_CU_UE_F1AP_ID;
               break;
            }

            case ProtocolIE_ID_id_gNB_DU_UE_F1AP_ID:
            {
               gnbDuUeF1apId = ueContextReleaseCommand->protocolIEs.list.array[ieIdx]->value.choice.GNB_DU_UE_F1AP_ID;
               break;
            }
               ...
               if (ueIdxFound == true)
               {
                  ...
                  if (duUeCb->f1UeDb)
                  {
                     ...
                     else
                     {
                        ...
                        memset(duUeCb->f1UeDb->dlRrcMsg, 0, sizeof(F1DlRrcMsg));
                        ret = extractDlRrcMsg(gnbDuUeF1apId, gnbCuUeF1apId, duUeCb->f1UeDb->dlRrcMsg,
                                              &ueContextReleaseCommand->protocolIEs.list.array[ieIdx]->value.choice.RRCContainer);
                     }
                  }
                  else
                  {
            ...
            if (paging->protocolIEs.list.array[ieIdx])
            {
               ...
               case ProtocolIE_ID_id_PagingIdentity:
               {
                  ...
                  case PagingIdentity_PR_cNUEPagingIdentity:
                  {
                     if (paging->protocolIEs.list.array[ieIdx]->value.choice.PagingIdentity.choice.cNUEPagingIdentity)
                     {
                        bitStringToInt(&paging->protocolIEs.list.array[ieIdx]->value.choice.PagingIdentity.choice.cNUEPagingIdentity->choice.fiveG_S_TMSI, &tmpPagingParam->sTmsi);
                     }
                     break;
                  }
